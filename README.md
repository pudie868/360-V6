...
---
 ...
 360 V6 的四核CPU表现还可以。开始我只是用它运行基础的 homeproxy 代理插件，后来逐渐加入 U 盘支持，可玩性也越来越高。如今功能虽然丰富了不少，但若只用于代理，运行仍然流畅迅速。更让我满意的是它的无线性能——信号强度明显超过我之前用原厂三个路由器组的 Mesh 网络，穿墙表现尤其出色。
